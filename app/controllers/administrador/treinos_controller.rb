class Administrador::TreinosController < Administrador::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @treino.save
        format.html { redirect_to administrador_treino_url(@treino), notice: "Treino was successfully created." }
  ...
  def update
    respond_to do |format|
      if @treino.update(treino_params)
        format.html { redirect_to administrador_treino_url(@treino), notice: "Treino was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to administrador_treinos_url, notice: "Treino was successfully destroyed." }
