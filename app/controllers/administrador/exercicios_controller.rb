class Administrador::ExerciciosController < Administrador::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @exercicio.save
        format.html { redirect_to administrador_exercicio_url(@exercicio), notice: "Exercicio was successfully created." }
  ...
  def update
    respond_to do |format|
      if @exercicio.update(exercicio_params)
        format.html { redirect_to administrador_exercicio_url(@exercicio), notice: "Exercicio was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to administrador_exercicios_url, notice: "Exercicio was successfully destroyed." }
