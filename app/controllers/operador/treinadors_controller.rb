class Operador::TreinadorsController < Operador::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @treinador.save
        format.html { redirect_to operador_treinador_url(@treinador), notice: "Treinador was successfully created." }
  ...
  def update
    respond_to do |format|
      if @treinador.update(treinador_params)
        format.html { redirect_to operador_treinador_url(@treinador), notice: "Treinador was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to operador_treinadors_url, notice: "Treinador was successfully destroyed." }
