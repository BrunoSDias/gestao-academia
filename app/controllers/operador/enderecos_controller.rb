class Operador::EnderecosController < Operador::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @endereco.save
        format.html { redirect_to operador_cliente_endereco_url(@cliente, @endereco), notice: "Endereco was successfully created." }
  ...
  def update
    respond_to do |format|
      if @endereco.update(endereco_params)
        format.html { redirect_to operador_cliente_endereco_url(@cliente, @endereco), notice: "Endereco was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to operador_cliente_enderecos_url(@cliente), notice: "Endereco was successfully destroyed." }
